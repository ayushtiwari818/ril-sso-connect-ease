                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        {fullView && (
                                            <div className="flex gap-2 mt-2">
                                                <button className="border border-[#181f60] text-[#181f60] rounded-full px-4 py-1 text-xs font-semibold">+ Assign Task</button>
                                                <button className="bg-[#4f5fff] text-white rounded-full px-4 py-1 text-xs font-semibold">Start Task</button>
                                            </div>
                                        )}
                                    </div>
                                </Card>
